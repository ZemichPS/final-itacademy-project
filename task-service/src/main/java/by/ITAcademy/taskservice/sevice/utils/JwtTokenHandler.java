package by.ITAcademy.taskservice.sevice.utils;


import by.ITAcademy.taskservice.config.property.JWTProperty;
...
public class JwtTokenHandler {
    ...
    public boolean validate(String token) {
        try {
            ...
            throw new JwtException(ex.getMessage(), ex.getCause());
